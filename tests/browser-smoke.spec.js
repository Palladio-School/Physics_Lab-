...
test('loads dashboard scripts in dependency order and exposes expected globals', async ({ page }) => {
  ...
  expect(scriptOrder).toEqual([
    ...
    'js/csv-row-utils.js',
    'js/readout-utils.js',
    'js/worksheet-utils.js',
    'js/panel-data-utils.js',
    'js/experiment-view-utils.js',
    'js/sonar-utils.js',
    'js/chart-utils.js',
  ...
  const globals = await page.evaluate(() => ({
    ...
    csvRows: Boolean(window.PalladioCsvRowUtils),
    readouts: Boolean(window.PalladioReadoutUtils),
    worksheets: Boolean(window.PalladioWorksheetUtils),
    panelData: Boolean(window.PalladioPanelDataUtils),
    experimentView: Boolean(window.PalladioExperimentViewUtils),
    sonar: Boolean(window.PalladioSonarUtils),
